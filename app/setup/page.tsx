            ...
            <CardContent>
              <ul className="list-disc ml-6 space-y-1">
                ...
                <li className="text-teal-400">
                  Carte mère : Asus PRIME B660-PLUS (DDR4)
                </li>
                <li className="text-cyan-300">RAM : 32 Go DDR4</li>
                <li className="text-blue-300">
                  Écrans : Gigabyte M27Q + Samsung T35F
                </li>
              </ul>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <ul className="list-disc ml-6 space-y-1">
                <li className="text-cyan-400 font-medium">
                  Micro + Casque : HyperX Cloud II
                </li>
                <li className="text-blue-400 font-medium">
                  Clavier : Akko MOD007B HE
                </li>
                ...
                <li className="text-blue-300 font-medium">
                  PC portable : Thinkpad Yoga X13
                </li>
                <li className="text-teal-300 font-medium">
                  Steam deck : OS CUSTOM
                </li>
